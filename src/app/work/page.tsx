...
const projects = [
  ...
  },
  {
    ...
    thumbnail: {
      type: 'image' as const,
      src: getImageUrl('/work/weights-biases-thumb.webp', 1200, { format: 'webp' }),
  ...
  },
  {
    ...
    thumbnail: {
      type: 'image' as const,
      src: getImageUrl('/work/boubyan-bank-thumb.webp', 1200, { format: 'webp' }),
      fallback: getImageUrl('/work/boubyan-bank-thumb.jpg', 1200, { format: 'jpg' }),
  ...
  },
  {
    ...
    thumbnail: {
      type: 'image' as const,
      src: getImageUrl('/work/salesforce-thumb.webp', 1200, { format: 'webp' }),
      fallback: getImageUrl('/work/salesforce-thumb.jpeg', 1200, { format: 'jpg' }),
  ...
  },
  {
    ...
    thumbnail: {
      type: 'image' as const,
      src: getImageUrl('/work/levis-thumb.webp', 1200, { format: 'webp' }),
      fallback: getImageUrl('/work/levis-thumb.jpg', 1200, { format: 'jpg' }),
  ...
  },
  {
    ...
    thumbnail: {
      type: 'image' as const,
      src: getImageUrl('/work/pwc-liftoff-thumb.webp', 1200, { format: 'webp' }),
      fallback: getImageUrl('/work/pwc-liftoff-thumb.jpg', 1200, { format: 'jpg' }),
  ...
  },
  {
    ...
    thumbnail: {
      type: 'image' as const,
      src: getImageUrl('/work/stability-ai-thumb.webp', 1200, { format: 'webp' }),
      fallback: getImageUrl('/work/stability-ai-thumb.jpg', 1200, { format: 'jpg' }),
  ...
  },
  {
    ...
    thumbnail: {
      type: 'image' as const,
      src: getImageUrl('/work/women-is-losers-thumb.webp', 1200, { format: 'webp' }),
      fallback: getImageUrl('/work/women-is-losers-thumb.jpeg', 1200, { format: 'jpg' }),
